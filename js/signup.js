...
/*
    ...
    jQuery(".next2").click(function(){
       // alert(document.getElementById("f5").value);
        if(jQuery.trim(document.getElementById("f5").value).length == 0){
            jQuery('.error1').html('<span style="color:red;">Please Enter a ' + document.getElementById("f5").getAttribute("placeholder") + '</span>');
            jQuery('.error2').show();
            return false;
        }else{
